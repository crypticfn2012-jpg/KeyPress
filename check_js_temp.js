...
/* =========================================================
   CHARM CATALOG — generated once at load from theme word-lists.
   Each box has its own catalog so drop pools stay distinct.
   Every charm template gets a fixed rarity, a unique-ish price
   (jittered around its rarity's base) and a cash-boost %.
========================================================= */
...
const MONSTER_ADJ = ["Tiny","Grumpy","Bouncy","Sneaky","Sparkly","Rusty","Fuzzy","Wobbly","Zappy","Gloopy","Spiky","Shiny","Sleepy","Feisty","Chunky","Glowing","Squishy","Cheeky","Mossy","Frosty"];
const MONSTER_NOUN = ["Blob","Sprite","Imp","Gremlin","Critter","Beastie","Wisp","Goblin","Sprocket","Muncher","Nibbler","Snapper","Hopper","Glimmer","Grub","Fang","Whisker","Scamp","Puff","Gloop"];
const MONSTER_EMOJI = ["👾","🐲","🐙","🦑","🐌","🐛","🦎","🐸","🦖","🦕","👹","👺","🤖","🎃","🦠","🐺","🦇","🐍","🦂","🦥"];
